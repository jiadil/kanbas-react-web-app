...
export default function AssignmentEditor() {
    ...
    const handleSave = () => {
        const newAssignment = {
            ...
            course: cid,
            due: (document.getElementById("wd-due-date") as HTMLInputElement).value + "Z",
            available: (document.getElementById("wd-available-from") as HTMLInputElement).value + "Z",
            until: (document.getElementById("wd-available-until") as HTMLInputElement).value + "Z"
        };
    ...
    // Keep your entire JSX the same, just change the Save button
    return (
        <div id="wd-assignments-editor" className="container mt-3">
            <form>
                <div className="mb-2">
                    <label htmlFor="wd-name" className="form-label">Assignment Name</label>
                    <input id="wd-name" defaultValue={existingAssignment.title} className="form-control" />
                </div>

                <div className="mb-3">
                    <label htmlFor="wd-description" className="form-label"></label>
                    <textarea id="wd-description" cols={30} rows={5} className="form-control" defaultValue={existingAssignment.description} />
                </div>
                ...
                <div className="row align-items-start mb-3">
                    ...
                    <div className="col">
                        <input type="text" className="form-control" id="wd-points" defaultValue={existingAssignment.points} />
                    </div>
                </div>
                    ...
                    <div className="col ps-3 pe-3">
                        <div className="col border p-3">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="datetime-local" className="form-control" id="wd-due-date" defaultValue={existingAssignment.due ? existingAssignment.due.slice(0, 16) : ""} />
                            </div>

                            <div className="row mb-3">
                                <div className="col">
                                    <label htmlFor="wd-available-from" className="form-label pt-1"><strong>Available From</strong></label>
                                    <input type="datetime-local" className="form-control" id="wd-available-from" defaultValue={existingAssignment.available ? existingAssignment.available.slice(0, 16) : ""} />
                                </div>
                                <div className="col">
                                    <label htmlFor="wd-available-until" className="form-label pt-1"><strong>Until</strong></label>
                                    <input type="datetime-local" className="form-control" id="wd-available-until" defaultValue={existingAssignment.until ? existingAssignment.until.slice(0, 16) : ""} />
                                </div>
                            </div>
                        </div>
                    </div>
